      ...
      <Dialog>
        <DropdownMenu>
          ...
          <DropdownMenuContent>
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem>
              <Link href={redirectUrls.uploadTheme}>Upload a theme...</Link>
            </DropdownMenuItem>
        ...
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Ready to color your website?</DialogTitle>
            <DialogDescription>
              1. Copy the content from{" "}
              <Link
                href={redirectUrls.downloadTheme(currentTheme.name)}
                className="text-primary"
              >
                this theme file.
              </Link>{" "}
              <br /> 2. Replace the content from the classes .root and .dark in
              your <span className="text-primary">global.css</span> file.
            </DialogDescription>
          </DialogHeader>
        </DialogContent>
      </Dialog>
